...
<tr><td>{{json_decode($f1->Operationalcatagory,true)[0]}}</td><td>{{json_decode($f1->Operationalnumber,true)[0]}}</td><td>{{json_decode($f1->Operationalunit,true)[0]}}</td><td>{{json_decode($f1->OperationalunitCost,true)[0]}}</td><td>{{json_decode($f1->Operationalsource,true)[0]}}</td></tr>
